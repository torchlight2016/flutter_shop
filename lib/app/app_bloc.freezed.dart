...
class _$AppStateImpl implements _AppState {
  const _$AppStateImpl({required this.colorSeed, required this.brightness});
  ...
  @override
  String toString() {
    return 'AppState(colorSeed: $colorSeed, brightness: $brightness)';
  }
...
abstract class _AppState implements AppState {
  const factory _AppState(
      ...
      required final Brightness brightness}) = _$AppStateImpl;
