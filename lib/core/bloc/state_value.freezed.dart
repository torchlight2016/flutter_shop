...
/// @nodoc
abstract class $StateValueCopyWith<T, $Res> {
  factory $StateValueCopyWith(
          StateValue<T> value, $Res Function(StateValue<T>) then) =
      _$StateValueCopyWithImpl<T, $Res, StateValue<T>>;
}

/// @nodoc
class _$StateValueCopyWithImpl<T, $Res, $Val extends StateValue<T>>
    implements $StateValueCopyWith<T, $Res> {
...
class __$$_InitialCopyWithImpl<T, $Res>
    extends _$StateValueCopyWithImpl<T, $Res, _$_Initial<T>>
...
abstract class _Initial<T> extends StateValue<T> {
...
class __$$_LoadingCopyWithImpl<T, $Res>
    extends _$StateValueCopyWithImpl<T, $Res, _$_Loading<T>>
...
abstract class _Loading<T> extends StateValue<T> {
...
class __$$_SuccessCopyWithImpl<T, $Res>
    extends _$StateValueCopyWithImpl<T, $Res, _$_Success<T>>
...
class _$_Success<T> extends _Success<T> {
  ...
  @override
  String toString() {
    return 'StateValue<$T>.success(data: $data)';
  }
...
abstract class _Success<T> extends StateValue<T> {
...
class __$$_FailureCopyWithImpl<T, $Res>
    extends _$StateValueCopyWithImpl<T, $Res, _$_Failure<T>>
...
class _$_Failure<T> extends _Failure<T> {
  ...
  @override
  String toString() {
    return 'StateValue<$T>.failure(error: $error, stackTrace: $stackTrace)';
  }
...
abstract class _Failure<T> extends StateValue<T> {
